...
NDA_GROUND_TRUTH = [
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["continue indefinitely", "in perpetuity", "continue in perpetuity", "indefinite term", "no end date", "perpetual", "indefinitely", "sunset", "section 5"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["cayman islands", "cayman", "governing law", "exclusive jurisdiction", "jurisdiction", "unfavorable jurisdiction", "offshore", "section 4"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["irreparable harm", "equitable relief", "injunctive relief", "monetary damages", "insufficient remedy", "remedies", "injunction", "specific performance", "section 6"],
...
SLA_GROUND_TRUTH = [
    {
        ...
        "severity": "critical",
        "keywords": ["uptime", "best of ability", "no specific", "objectives", "no numeric", "vague", "availability", "99.5", "99.9", "section 2"],
    ...
    },
    {
        ...
        "severity": "critical",
        "keywords": ["$500", "500", "liability", "caps", "not exceed", "aggregate", "too low", "inadequate", "liability cap", "section 3"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["reasonable timeframe", "no specific timelines", "incident", "vague timeframe", "incident response", "response time", "section 4"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["12 months", "30 days", "termination", "asymmetric", "unbalanced", "notice period", "exit clause", "section 5"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["maintenance", "any time", "without advance notice", "unilateral", "disruption", "downtime", "section 6"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["audit", "discretion", "no commit", "compliance", "no specific audit", "soc 2", "certification", "section 7"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["breach", "when discovered", "no specific", "notification", "timeline guaranteed", "data breach", "breach notification", "section 8"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["data", "deleted", "30 days", "termination", "retention", "data deletion", "gdpr", "data portability"],
...
MA_GROUND_TRUTH = [
    {
        ...
        "severity": "critical",
        "keywords": ["irs", "$2.3 million", "2.3", "assessment", "transfer pricing", "not disclosed", "audit", "tax", "undisclosed", "section 6"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["patent", "infringement", "three", "$5 million", "competing entities", "ip liability", "intellectual property", "undisclosed", "section 8"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["indemnification", "cap", "5%", "$2,500,000", "2,500,000", "fraud", "breach of warranty", "indemnity", "section 3"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["18 months", "non-compete", "exclusivity", "brand", "customer relationships", "restrictive", "post-closing", "section 5"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["reverse termination", "fee", "buyer terminates", "pre-closing", "no", "reimbursement", "termination fee", "break fee", "section 10"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["escrow", "12 months", "release", "without requirement", "audit", "$10 million", "section 4"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["doj", "antitrust", "inquiry", "data sharing", "not disclosed", "compliance", "regulatory", "undisclosed", "section 9"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["tax liabilities", "periods prior", "indemnify", "unlimited", "pre-close", "no cap", "tax indemnity", "survival limit", "section 6"],
