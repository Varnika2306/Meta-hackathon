...
NDA_GROUND_TRUTH = [
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["continue indefinitely", "in perpetuity", "continue in perpetuity", "indefinite term", "no end date"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["cayman islands", "governing law", "exclusive jurisdiction", "jurisdiction"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["irreparable harm", "equitable relief", "injunctive relief", "monetary damages", "insufficient remedy"],
...
SLA_GROUND_TRUTH = [
    {
        ...
        "severity": "critical",
        "keywords": ["uptime", "best of ability", "no specific", "objectives", "no numeric", "vague"],
    ...
    },
    {
        ...
        "severity": "critical",
        "keywords": ["$500", "liability", "caps", "not exceed", "aggregate", "too low", "inadequate"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["reasonable timeframe", "no specific timelines", "incident", "vague timeframe"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["12 months", "30 days", "termination", "asymmetric", "unbalanced"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["maintenance", "any time", "without advance notice", "unilateral", "disruption"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["audit", "discretion", "no commit", "compliance", "no specific audit"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["breach", "when discovered", "no specific", "notification", "timeline guaranteed"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["data", "deleted", "30 days", "termination", "retention"],
...
MA_GROUND_TRUTH = [
    {
        ...
        "severity": "critical",
        "keywords": ["irs", "$2.3 million", "assessment", "transfer pricing", "not disclosed", "audit"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["patent", "infringement", "three", "$5 million", "competing entities", "ip liability"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["indemnification", "cap", "5%", "$2,500,000", "fraud", "breach of warranty"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["18 months", "non-compete", "exclusivity", "brand", "customer relationships", "restrictive"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["reverse termination", "fee", "buyer terminates", "pre-closing", "no", "reimbursement"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["escrow", "12 months", "release", "without requirement", "audit"],
    ...
    },
    {
        ...
        "severity": "high",
        "keywords": ["doj", "antitrust", "inquiry", "data sharing", "not disclosed", "compliance"],
    ...
    },
    {
        ...
        "severity": "medium",
        "keywords": ["tax liabilities", "periods prior", "indemnify", "unlimited", "pre-close", "no cap"],
